...
class CaptionsMenu {
    constructor(args) {
        var that = this, element = Ayamel.utils.parseHTML(template), playerElement = args.player.element;
    ...
    resize() {
        ...
        resizeMenu(this.element.querySelector('.menu'), this.playerElement.getBoundingClientRect().top);
    }
}
