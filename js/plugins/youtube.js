...
class YouTubePlayer {
            ...
            init: {
                value: function () {
                    ...
                    function timeUpdate() {
                        ...
                        if (Animation && Animation.requestFrame) {
                            Animation.requestFrame(timeUpdate);
                        }
                        else {
                        ...
                        events: {
                            ...
                            onError: function (event) {
                                switch (event.data) {
                                    ...
                                    case 101:
                                    case 150:
                                        alert("This video can only be watched on YouTube");
                                        return;
                                }
                            }
                        }
    ...
    enterFullScreen(availableHeight) {
...
export default {
    register: function(ayamel) {
        ayamel.mediaPlugins.video.youtube = plugin;
    }
};
